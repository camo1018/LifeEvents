...
{
    // Save data.  Index 0 contains all entered products, 1 contains all the products that meet the filter settings, and 2 contains all the categories.
    NSMutableArray *components = [[NSMutableArray alloc] initWithObjects:self.dataArray, self.filterArray, self.fieldArray, nil];
